...
class TrackerGUI(QWidget):
    ...
    def build_line_portfolio(
        self, csvpath: str, feesOn: bool = True, startDate: str = "", endDate: str = ""
    ):
        # temp stuffs
        self.csv = utils.convertCSV(csvpath)
        self.balance_series = utils.getBalanceSeries(
            self.csv, feesOn, startDate, endDate
        )
